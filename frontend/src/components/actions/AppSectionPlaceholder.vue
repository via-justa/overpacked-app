...
<template>
  <section data-component="app-section-placeholder" :data-section="title.toLowerCase()"
    class="surface-panel p-8 sm:p-10">
    <h1 class="text-ink text-3xl font-bold sm:text-4xl">{{ title }}</h1>
