...
<template>
  <AppTemplateDialog :model-value="open" :width="width ?? 'min(44rem, calc(100vw - 2rem))'" :data-element="dataElement"
    ...
    <article class="surface-panel p-4 flex flex-col">
      ...
      <footer class="mt-4 flex shrink-0">
        <Button label="Close" :icon="`pi ${iconRegistry.action.cancel}`" severity="secondary" outlined
